...
class KafkaArchTest {
    ...
    void consumersShouldBeInTheirPackage() {
        ...
        classes()
            ...
            .should()
            .resideInAPackage("com.project.service.kafka.consumer")
    ...
    void producersShouldBeInTheirPackage() {
        ...
        classes()
            ...
            .should()
            .resideInAPackage("com.project.service.kafka.producer")
    ...
    void serializersShouldBeInTheirPackage() {
        ...
        classes()
            ...
            .should()
            .resideInAPackage("com.project.service.kafka.serde")
    ...
    void consumersShouldExtendGenericConsumer() {
        ...
        JavaClasses importedClasses = new ClassFileImporter()
            .withImportOption(ImportOption.Predefined.DO_NOT_INCLUDE_TESTS)
            .importPackages("com.project.service.kafka.consumer");
    ...
    void producersShouldBeServices() {
        ...
        JavaClasses importedClasses = new ClassFileImporter()
            .withImportOption(ImportOption.Predefined.DO_NOT_INCLUDE_TESTS)
            .importPackages("com.project.service.kafka.producer");
